...
from policy import load_mixed_policy
...
_tmp = GameEnv(opponent_policy=lambda s: Action.P2_TRAIN_MARINES, initial_state=S_INIT)
fsp_p2 = load_mixed_policy('fsp_sigma_p2.npy', _tmp.S, Action.P2_ACTIONS)
env = GameEnv(opponent_policy=fsp_p2, initial_state=S_INIT)
...
ax1.set_title('Estimated value of initial state across solvers (FSP opponent)')
ax1.axhline(0, color='gray', linestyle='--', linewidth=0.8)
ax1.legend()
fig1.tight_layout()
fig1.savefig('v0_comparison_fsp.png', dpi=150)
...
ax2.set_title('MCTS: estimate sharpening with rollouts (FSP opponent)')
ax2.axhline(0, color='gray', linestyle='--', linewidth=0.8)
fig2.tight_layout()
fig2.savefig('v0_mcts_rollouts_fsp.png', dpi=150)
...
ax3.set_ylabel('Rate')
ax3.set_title(f'Win rates by solver vs. FSP opponent (n={N_EVAL} games)')
ax3.set_ylim(0, 1)
ax3.legend()
fig3.tight_layout()
fig3.savefig('mdp_winrates_fsp.png', dpi=150)
print("Saved mdp_winrates_fsp.png")
